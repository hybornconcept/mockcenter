...
>
	...
	>
		...
		>
			<!-- Logo Mock -->
			<a href="/dashboard" class="flex items-center gap-2.5 overflow-hidden group/logo">
				<div
		...
		<div class="flex flex-col mt-1 gap-y-5 {isExpanded ? 'px-4' : 'px-3'}">
			...
			<!-- SETTINGS & LOGOUT -->
			<div class="mt-auto pb-4 flex flex-col gap-0.5 border-t border-gray-50 pt-4">
				<a
					href="/settings"
			...
			<div class="flex items-center gap-4">
				{#if !isExpanded}
					<button
						...
						title="Show Sidebar"
					>
						<ChevronRight class="w-4 h-4 group-hover/show:translate-x-0.5 transition-transform" />
					</button>
				{/if}
