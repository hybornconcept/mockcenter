...
// These table names and column names are dictated by Better Auth's Drizzle adapter.
// Do NOT rename columns. The adapter maps our Drizzle objects to its internal model.
